...
public class JavaMailWithImageAttachment {
    ...
    public static void main(String args[]) throws AddressException, MessagingException {
        ...
        final String sourceEmail = "****@gmail.com"; // requires valid Gmail id
        final String password = "****"; // correct password for Gmail id
        final String toEmail = "****@gmail.com"; // any destination email id
        ...
        generateAndSendEmail(
                session,
                toEmail,
                "Raghu's JavaMail API example with Image Attachment",
                "Greetings, <br><br>Test email by Raghu JavaMail API example. Please find here attached Image."
                        + "<br><br> Regards, <br>Raghu");
    ...
    public static void generateAndSendEmail(Session session, String toEmail, String subject,
        ...
        try {
            ...
            crunchifyMessage.setFrom(new InternetAddress("*****@gmail.com",
                    "****"));
            crunchifyMessage.setReplyTo(InternetAddress.parse("******@gmail.com", false));
            ...
            // Valid file location
            String filename = "C:/******/DSC_1760.JPG";
